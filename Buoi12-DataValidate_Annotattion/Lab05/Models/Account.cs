...
namespace Lab05.Models
{
    public class Account
    {
        ...
        [
            ...
            //RegularExpression(@"^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$",ErrorMessage ="SĐT không đúng định dạng"),
        ...
        [
            ...
            Url(ErrorMessage ="Url phải đúng định dạng bao gồm http hoặc https, tên miền VD: http://facebook.com/itvnsoft")
            ]
