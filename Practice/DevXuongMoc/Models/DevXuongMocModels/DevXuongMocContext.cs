...
namespace DevXuongMoc.Models.DevXuongMocModels;
...
//        => optionsBuilder.UseSqlServer("Server=.;Database=DevXuongMoc;Trusted_Connection=True;TrustServerCertificate=True;MultipleActiveResultSets=True");
