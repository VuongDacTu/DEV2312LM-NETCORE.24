...
namespace Lesson06.Theory.CF.Controllers
{
    public class BooksController : Controller
    {
        ...
        {
            var bookManagementContext = _context.Book.Include(b => b.Category).Include(b => b.Publisher);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,Author,Release,Price,Description,Picture,PublisherId,CategoryId")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
