...
using Lesson06_Theory.Models;

namespace Lesson06_Theory.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var categoryStoreContext = _context.Categories;
            //ViewBag.categoryname = categoryStoreContext.
